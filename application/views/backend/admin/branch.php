        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo get_phrase('All Branches');?></span>
                </a>
            </li>
        </ul>
                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th class="span3"><div><?php echo get_phrase('Branch Name');?></div></th>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_branch_edit/<?php echo $row['branch_id'];?>');">

...
<hr />
<div class="row">
    <form action="<?php echo base_url();?>index.php?admin/report/refund_receipt" method="post">
        <div class="row">
        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo get_phrase('refund_receipt');?></span>
                </a>
            </li>
        </ul>
...
<div id="table_header" style="display: none;">
    ...
    <h3 style="width: 100%;float: left;text-align: center">Report Name : Refund Receipt</h3>
    <hr>

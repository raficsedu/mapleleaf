    ...
    <div class="col-md-12" id="printableArea">
        <table class="table table-bordered datatable" id="table_export">
            ...
            <tr>
                ...
                <th><div><?php echo get_phrase('JUL');?></div></th>
                <th><div><?php echo get_phrase('AUG');?></div></th>
                <th><div><?php echo get_phrase('SEP');?></div></th>
                <th><div><?php echo get_phrase('OCT');?></div></th>
                <th><div><?php echo get_phrase('NOV');?></div></th>
                <th><div><?php echo get_phrase('DEC');?></div></th>
                <th><div><?php echo get_phrase('EV');?></div></th>
                <th><div><?php echo get_phrase('ADM');?></div></th>

                ...
                <div id="01" style="margin-top: 2%;">
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="capacity_<?php echo $i;?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus>
                            </div>
                        </div>
                    <?php
                    }
                ...
                <div id="07" style="margin-top: 2%;">
                    ...
                    for($i = $sy ; $i <= $ey ; $i++){
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="capacity_<?php echo $ny;?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus>
                            </div>
                        </div>
                    <?php
                    }

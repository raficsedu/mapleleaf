...
?>
<div class="row">
    <form action="<?php echo base_url();?>index.php?admin/report/class_section_wise_student" method="post">
        <div class="row">
            ...
            <div class="col-sm-2">
                <input type="text" id="year" class="form-control" name="year" value="<?php echo $_POST['year'];?>" placeholder="Year" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
            </div>
        ...
        <div class="row" style="margin-top: 2%">
            ...
            <label for="field-2" class="col-sm-1 control-label"><?php echo get_phrase('Student Status');?></label>
            <div class="col-sm-2">
                <select name="student_status" class="form-control" id="student_status">
                    <option value=""><?php echo get_phrase('student status');?></option>
                    <option value="0" <?php if($_POST['student_status']=='0')echo 'selected';?>>Non Teacher</option>
                    <option value="1" <?php if($_POST['student_status']=='1')echo 'selected';?>>Teacher</option>
                    <option value="2" <?php if($_POST['student_status']=='2')echo 'selected';?>>Scholarship</option>
                    <option value="3" <?php if($_POST['student_status']=='3')echo 'selected';?>>Teacher + Scholarship</option>
                    <option value="4" <?php if($_POST['student_status']=='4')echo 'selected';?>>Special</option>
                </select>
            </div>
            ...
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    foreach($students as $row):
                        ...
                        <td><?php if($row['s_session']=='01'){echo 'JAN';}else{echo 'JUL';}?></td>
                        ...
                        <td><?php echo $this->crud_model->get_building_name('building',$row['building_info'],'building_name');?></td>
                        <td><?php if($row['parent_status']=='0'){echo 'Non Teacher';}elseif($row['parent_status']=='1'){echo 'Teacher';}elseif($row['parent_status']=='2'){echo 'Scholarship';}elseif($row['parent_status']=='3'){echo 'Teacher + Scholarship';}elseif($row['parent_status']=='4'){echo 'Special';}?></td>

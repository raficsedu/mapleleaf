<hr />
<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/fees_add/');"
        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo get_phrase('All Fees');?></span>
                </a>
            </li>
        </ul>
                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th class="span3"><div><?php echo get_phrase('Fee Name');?></div></th>
                            <th class="span3"><div><?php echo get_phrase('Fee Amount');?></div></th>
                            <th class="span3"><div><?php echo get_phrase('Comment');?></div></th>
                            <th class="span3"><div><?php echo get_phrase('options');?></div></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                                $buildings   =   $this->db->get('fees')->result_array();
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_fees_edit/<?php echo $row['id'];?>');">
                                        ...
                                        <li>
                                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/fees/delete/<?php echo $row['id'];?>');">

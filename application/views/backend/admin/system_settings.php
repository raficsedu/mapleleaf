...
<div class="col-md-6">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo get_phrase('VAT'); ?></label>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo get_phrase('Fine Amount'); ?></label>

                <div class="col-sm-9">
                    <input type="text" class="form-control" name="fine_amount"
                           value="<?php echo $this->db->get_where('settings', array('type' => 'fine_amount'))->row()->description; ?>">
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo get_phrase('Fine Applicable date'); ?></label>

                <div class="col-sm-9">
                    <input type="text" class="form-control" name="fine_date"
                           value="<?php echo $this->db->get_where('settings', array('type' => 'fine_date'))->row()->description; ?>">
                </div>
            </div>
